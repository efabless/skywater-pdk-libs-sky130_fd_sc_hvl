...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbufhv2lv_simple.timing.pp.v"
`endif // FUNCTIONAL

`else  // USE_POWER_PINS

`ifdef FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbufhv2lv_simple.functional.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbufhv2lv_simple.timing.v"
`endif // FUNCTIONAL
