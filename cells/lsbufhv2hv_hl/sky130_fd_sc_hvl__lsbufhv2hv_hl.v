...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbufhv2hv_hl.timing.pp.v"
`endif // FUNCTIONAL

`else  // USE_POWER_PINS

`ifdef FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbufhv2hv_hl.functional.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbufhv2hv_hl.timing.v"
`endif // FUNCTIONAL
