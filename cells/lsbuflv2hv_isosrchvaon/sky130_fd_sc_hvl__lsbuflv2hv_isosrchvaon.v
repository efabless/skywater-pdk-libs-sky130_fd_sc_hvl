...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbuflv2hv_isosrchvaon.timing.pp.v"
`endif // FUNCTIONAL

`else  // USE_POWER_PINS

`ifdef FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbuflv2hv_isosrchvaon.functional.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hvl__lsbuflv2hv_isosrchvaon.timing.v"
`endif // FUNCTIONAL
